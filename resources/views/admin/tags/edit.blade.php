                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="name_en" name="name[en]" 
                               value="{{ old('name.en', $tag->name['en'] ?? '') }}" required>
                        @error('name.en')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="name_es" name="name[es]" 
                               value="{{ old('name.es', $tag->name['es'] ?? '') }}" required>
                        @error('name.es')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="color" class="form-control form-control-color p-1" id="color_bg" 
                                   name="color_bg" value="{{ old('color_bg', $tag->color_bg) }}" required>
                            <input type="text" class="form-control" value="{{ old('color_bg', $tag->color_bg) }}" 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="color" class="form-control form-control-color p-1" id="color_text" 
                                   name="color_text" value="{{ old('color_text', $tag->color_text) }}" required>
                            <input type="text" class="form-control" value="{{ old('color_text', $tag->color_text) }}" 
